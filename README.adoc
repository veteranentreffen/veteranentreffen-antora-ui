...
This is based off https://gitlab.com/antora/antora-ui-default

The Antora UI files for https://veteranentreffen.github.io/ are generated here.

== Using this UI in your Antora project
...
Copyright (C) of the original Default UI: 2017-2018 OpenDevise Inc. and the Antora Project.
